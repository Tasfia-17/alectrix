...
const WordSearchCell = React.memo<WordSearchCellProps>(({ letter, rIndex, cIndex, isSelected, onMouseDown, onMouseEnter }) => (
    <div 
        ...
        ${isSelected ? 'bg-pastel-yellow rounded-md' : ''}`}
...
const WordSearchPuzzle: React.FC<{ data: WordSearchData }> = ({ data }) => {
    ...
    const handleMouseUp = useCallback(() => {
        ...
        setStartCell(null);
        setCurrentCell(null);
    }, [isSelecting, startCell, currentCell, grid, normalizedWords, foundWords]);
