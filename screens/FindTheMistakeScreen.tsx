...
const Word = React.memo(({ word, isSelected, isIncorrect, onClick }: { word: string, isSelected: boolean, isIncorrect: boolean, onClick: () => void }) => (
    <span 
        onClick={onClick}
...
const FindTheMistakeScreen: React.FC<FindTheMistakeScreenProps> = ({ gameData, onBack }) => {
    ...
    }, [incorrectAttempt, foundMistakes, words]);
                ...
                i += mistakeWordCount;
                 ...
                 renderedWords.push(
                     <Word 
                        ...
                        onClick={() => handleWordClick(currentIndex)}
                    />
                 );
                 renderedWords.push(' ');
                 i++;
    ...
    }, [words, foundMistakes, selectedIndices, incorrectAttempt, handleWordClick]);
